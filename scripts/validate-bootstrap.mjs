...
const required = [
  ...
  "src/agent/codex-rpc-client.ts", "src/transport/qq/qq-transport.ts",
  "docs/ENVIRONMENT_SETUP.md", "scripts/bootstrap-macos.sh",
...
if (!pkg.scripts?.doctor || !pkg.scripts?.build) throw new Error("Required scripts missing");
