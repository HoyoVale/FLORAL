...
export function renderConfigurationAuthority(
  ...
  const lines = [
    ...
    `config.codex.memories.enabled=${String(authority.effective.codex.memories.enabled)}`,
    ...
    `config.qq.presentation.native_typing=${String(authority.effective.qq.presentation.native_typing)}`,
