...
const envSchema = z.object({
  ...
  GOAL_CONTINUATION_ENABLED: booleanString.default(true),
  GOAL_CONTINUATION_COOLDOWN_MS: z.coerce.number().int().min(1_000).max(300_000).default(30_000),
  GOAL_CONTINUATION_MAX_TURNS: z.coerce.number().int().min(0).max(10_000).default(0),
  GOAL_CONTINUATION_MAX_WALL_TIME_MS: z.coerce.number().int().min(0).max(7 * 24 * 60 * 60_000).default(0),
